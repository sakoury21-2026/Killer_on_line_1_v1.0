using UnityEngine; // נותן גישה ל-MonoBehaviour, ל-SerializeField ול-Debug של Unity.

[RequireComponent(typeof(PlayerMovement))] // מוודא שעל אותו GameObject יהיה גם PlayerMovement שמחזיק את מצב הכריעה האמיתי.
public class PlayerStealthState : MonoBehaviour // מגדיר Component שמרכז את מצב ההתגנבות של השחקן עבור HideZone ועבור LaurenAI.
